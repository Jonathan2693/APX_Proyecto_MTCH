...
/**
 * Test for transaction MTCHT00101MXTransaction
 */
@RunWith(SpringJUnit4ClassRunner.class)
@ContextConfiguration(locations = {
		"classpath:/META-INF/spring/elara-test.xml",
		"classpath:/META-INF/spring/MTCHT00101MXTest.xml" })
public class MTCHT00101MXTransactionTest {
	private static final Logger LOGGER = LoggerFactory.getLogger(MTCHT00101MXTransactionTest.class);

	@Autowired
	private MTCHT00101MXTransaction transaction;
